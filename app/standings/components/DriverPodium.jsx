      ...
      <div className="driver-podium-container">
          ...
          <div className="driver-podium-first-container">
            <Link href={`drivers/${firstPlace.driverId}`}>
              ...
              <Image className="object-contain" src={`/assets/images/drivers/${firstPlace.driverId}_front.png`} alt={`${firstPlace.familyName}'s image`} width={100} height={100} />
              </div>
            </Link>
          </div>
          <div className="driver-podium-second-container">
            <Link href={`drivers/${secondPlace.driverId}`}>
                <div className="w-[100px] h-[100px] rounded-full overflow-hidden bg-gray-100">
                <Image className="object-contain" src={`/assets/images/drivers/${secondPlace.driverId}_front.png`} alt={`${secondPlace.familyName}'s image`} width={100} height={100} />
                </div>
              </Link>
          </div>
          <div className="driver-podium-third-container">
            <Link href={`drivers/${thirdPlace.driverId}`}>
                <div className="w-[100px] h-[100px] rounded-full overflow-hidden bg-gray-100">
                <Image className="object-contain" src={`/assets/images/drivers/${thirdPlace.driverId}_front.png`} alt={`${thirdPlace.familyName}'s image`} width={100} height={100} />
                </div>
              </Link>
          </div>
      </div>
