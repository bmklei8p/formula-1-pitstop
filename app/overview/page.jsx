...
const OverviewPage = async () => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
        <div className="hidden md:flex justify-center items-end xl:items-start relative ">
            <div className="h-36 lg:h-56 xl:h-56 w-2/4 absolute z-40 flex flex-col justify-center items-center opacity-90">
                <h1 className=" text-4xl lg:text-6xl font-bold text-white">Formula 1 Pitstop</h1>
                <p className="text-white text-3xl lg:text-5xl ">Your <strong>one-stop</strong> for F1</p>
            </div>
            <Image src="/assets/images/home-pit-stop-desktop.png" alt="pit-stop" width={4111} height={1100} className="-z-10 opacity-95" />
        </div>
        <div className="flex max-h-[90vh] md:hidden overflow-clip relative justify-center items-end ">
            <div className="h-26 w-full absolute z-40 flex flex-col justify-end py-2 items-center bg-gradient-to-t opacity-75 to-[#494949] from-[#2b2b2b]">
                <h1 className="text-white text-4xl">Formula 1 Pitstop</h1>
                <p className="text-white text-3xl">Your one-stop for F1</p>
            </div>
            <Image src="/assets/images/home-pit-stop-desktop-rotated.png" alt="pit-stop" width={4111} height={1100} className="-z-10 object-fill" />
        </div>
      {/* Content */}
