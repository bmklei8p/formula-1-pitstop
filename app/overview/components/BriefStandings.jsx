...
const BriefStandings = async () => {
  const driversStandingsResponse = await fetch(`https://ergast.com/api/f1/current/driverStandings.json`)
  ...
  const constructorsStandingsResponse = await fetch(`https://ergast.com/api/f1/current/constructorStandings.json`)
